...
class _ServerTabState extends State<ServerTab> {
  ...
  String? _localIp;
  ServerService get _serverService => ServerService();
  bool _isServerRunning = false;
  String? _currentPin;
  final List<String> _serverLogs = [];
  List<DiscoveredVault> _nearbyVaults = [];

  DiscoveryService get _discoveryService => DiscoveryService();
  ...
  void _toggleServer() async {
    if (_isServerRunning) {
      ...
      _serverService.init(_selectedDirectoryPath!, pin, logCb: (msg) {
        if (mounted) {
          setState(() {
